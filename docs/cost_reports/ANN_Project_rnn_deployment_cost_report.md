...
Model Size: 432.87 KB

Model files:
- ANN_Project\best_model.pth — 56.05 KB
- ANN_Project\models\best_model.pth — 186.74 KB
- ANN_Project\models\final_model.pth — 190.08 KB
Dataset Size: 1.85 MB

Dataset sources:
- ANN_Project\data — 1.85 MB
