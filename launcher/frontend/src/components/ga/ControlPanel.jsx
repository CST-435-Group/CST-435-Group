    ...
    <div className="ga-control-panel">
      ...
      <div className="ga-controls">
        {!isRunning && !isComplete && (
          <button className="ga-btn ga-btn-start" onClick={handleStart}>
            Start Evolution
          </button>
        )}
        {isRunning && (
          <button className="ga-btn ga-btn-stop" onClick={onStop}>
            Stop
          </button>
        )}
        {(isComplete || isRunning) && (
          <button className="ga-btn ga-btn-reset" onClick={onReset}>
            Reset
          </button>
        )}
      </div>
      ...
      {isComplete && (
        <div className="ga-completion-message">
